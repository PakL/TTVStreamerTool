...
class ToolSettings extends UIPage {
	...
	constructor(tool) {
		...
		this._tool.on('load', () => {
			...
			self.appendSetting('filteremotespam', self._tool.i18n.__('Filter emote spam'), 'checkbox', { set: 'chat_filter', setLabel: self._tool.i18n.__('Chat filter'), description: self._tool.i18n.__('This filters out any messages that are only emotes and contains at least 3 emotes.'), default: false })
			self.appendSetting('filterbotcommands', self._tool.i18n.__('Filter bot commands'), 'checkbox', { set: 'chat_filter', description: self._tool.i18n.__('This filters out any messages beginning with an exclamation mark (!) and messages by known bots (Moobot).'), default: false })
