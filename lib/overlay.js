...
class Overlays extends UIPage {
	...
	constructor(toolui) {
		...
		this.appendSetting('', this._ui.i18n.__('Live volume control'), 'range', {set: 'music', default: parseFloat(this.tool.settings.getString('overlay_music_volume', '50')), min: 0, max: 100, onchange: (e) => {
		...
		this.appendSetting('', this._ui.i18n.__('Overlay set time target command'), 'text', {attrid: 'timer_set_cmd', set: 'timer', readonly: true, default: 'timer_set=12:00', 'description': this._ui.i18n.__('Use this command in an hotkey to let the countdown count down to a specific point in time. Format: YY-MM-DD hh:mm:ss; Hours must be in the 24 hour format, date and seconds are optional. If the given date is in the past nothing will happen. Example: timer_set=2018-09-08 13:00:00 or timer_set=15:00')})
