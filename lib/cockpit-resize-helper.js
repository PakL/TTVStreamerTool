...
class ResizeDragger {
	...
	saveSettings() {
		Tool.settings.setString(ResizeDragger.getVarNameFor(this.dragger, 'top'), this.dragger.style.top)
		Tool.settings.setString(ResizeDragger.getVarNameFor(this.dragger, 'left'), this.dragger.style.left)
		Tool.settings.setString(ResizeDragger.getVarNameFor(this.dragger, 'width'), this.dragger.style.width)
		
		Tool.settings.setString(ResizeDragger.getVarNameFor(this.resizeElement, 'top'), this.resizeElement.style.top)
		Tool.settings.setString(ResizeDragger.getVarNameFor(this.resizeElement, 'left'), this.resizeElement.style.left)
		Tool.settings.setString(ResizeDragger.getVarNameFor(this.resizeElement, 'width'), this.resizeElement.style.width)
		Tool.settings.setString(ResizeDragger.getVarNameFor(this.resizeElement, 'height'), this.resizeElement.style.height)
		
		for(let i = 0; i < this.spaceMaker.length; i++) {
			Tool.settings.setString(ResizeDragger.getVarNameFor(this.spaceMaker[i], 'width'), this.spaceMaker[i].style.width)
			Tool.settings.setString(ResizeDragger.getVarNameFor(this.spaceMaker[i], 'height'), this.spaceMaker[i].style.height)
		}
	}
